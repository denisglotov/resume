...
- Designed and implemented an oracle daemon to monitor multiple blockchains, sign relevant events, achieve peer consensus, and persist data in block format.
